# SpecStory and implementation evidence
...
The **Review both with the coordinator** step below is handled by `/improve-workflow`.
...
```text
/improve-workflow Review ~/.claude/implement/PROJECT-TASK and this worktree's .specstory/history.
